...
class Program
{
    static void Main()
    {
        ...
        russia.NewAnimalResponse("hamster");
        ...
        russia.NewTraitOfCharacterResponse("fun");
        ...
        japan.NewAnimalResponse("capybara");
        ...
        japan.NewTraitOfCharacterResponse("fun");
        japan.NewTraitOfCharacterResponse("fun");
        ...
        combined.NewTraitOfCharacterResponse("fun");
        combined.NewTraitOfCharacterResponse("kindness");
        combined.NewTraitOfCharacterResponse("creativity");
        combined.NewTraitOfCharacterResponse("politeness");
        combined.NewTraitOfCharacterResponse("sense of humour");
        ...
        //string[][] allResponses = new string[3][];
        //int[][] allCounts = new int[3][];

        //allResponses[0] = new string[50];
        //allCounts[0] = new int[50];
        //allResponses[1] = new string[50]; 
        //allCounts[1] = new int[50];
        //allResponses[2] = new string[50]; 
        //allCounts[2] = new int[50];

        //int index = 0;

        //foreach (var response in russia.country_response.GetAllResponses())
        //{
        //    allResponses[0][index] = response;
        //    allCounts[0][index] = russia.country_response.GetCount(russia.country_response.Animal, response);
        //    index++;
        //}
        ...
        //{
        //    allResponses[0][index] = response;
        //    allCounts[0][index] = japan.country_response.GetCount(japan.country_response.Animal, response);
        //    index++;
        //}


        //index = 0;
        //foreach (var response in russia.country_response.GetTraitOfCharacterResponses())
        //{
        //    allResponses[1][index] = response;
        //    allCounts[1][index] = russia.country_response.GetCount(russia.country_response.TraitOfCharacter, response);
        //    index++;
        //}

        //index = 0;
        //foreach (var response in japan.country_response.GetTraitOfCharacterResponses())
        //{
        //    allResponses[1][index] = response;
        //    allCounts[1][index] = japan.country_response.GetCount(japan.country_response.TraitOfCharacter, response);
        //    index++;
        //}


        //index = 0;
        //foreach (var response in russia.country_response.GetObjectResponses())
        //{
        //    allResponses[2][index] = response;
        //    allCounts[2][index] = russia.country_response.GetCount(russia.country_response.Object, response);
        //    index++;
        //}

        //index = 0;
        //foreach (var response in japan.country_response.GetObjectResponses())
        //{
        //    allResponses[2][index] = response;
        //    allCounts[2][index] = japan.country_response.GetCount(japan.country_response.Object, response);
        //    index++;
        //}

        //Console.WriteLine(" ");
        //Console.WriteLine("Combined top responses:");

        //for (int i = 0; i < 3; i++)
        //{
        //    Console.WriteLine($"Top responses for category {i + 1}:");
        //    russia.country_response.PrintTopResponsesForAllQuestions(allResponses[i], allCounts[i]);
        //}
    }
}